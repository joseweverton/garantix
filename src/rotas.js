...
import { camposPeril, camposUsuarios, emailSenha } from "./middlewares/JOI/schemas.js";
...
routes.put("/usuarios", validarCorpoRequisicao(camposPeril), UsuariosController.editarPerfilUsuario);
